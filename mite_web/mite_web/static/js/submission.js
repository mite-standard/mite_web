                        ...
                        <div class="row mb-2">
                            <div class="col">
                                <div class="form-floating">
                                    ...
                                    <div id="ReactionSmartsHelp" class="form-text">The reaction SMARTS depicting the reaction - draw it using <a rel="Ketcher Chemistry drawing program" href="https://lifescience.opensource.epam.com/KetcherDemoSA/index.html" class="custom-link" target="_blank"><b>Ketcher</b></a>. Please include any co-factors the substrate(s)/product(s) may be attached to.</div>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-2">
            ...
            <div class="row mb-2">
                <div class="col">
                    <div class="form-floating">
                        ...
                        <div id="KnownReactionSubstrateHelp" class="form-text">The reaction substrate SMILES string - draw it using <a rel="Ketcher Chemistry drawing program" href="https://lifescience.opensource.epam.com/KetcherDemoSA/index.html" class="custom-link" target="_blank"><b>Ketcher</b></a>. Please include any co-factors the substrate(s) may be attached to. Multiple substrates must be specified with dot notation ('substrate1.substrate2')</div>
                    </div>
                </div>
            </div>
            <div class="row mb-2">
        ...
        <div class="row d-flex align-items-center mb-1">
            <div class="col">
                <div class="form-floating">
                    ...
                    <div id="ReactionProductsHelp" class="form-text">A single reaction product SMILES string - draw it using <a rel="Ketcher Chemistry drawing program" href="https://lifescience.opensource.epam.com/KetcherDemoSA/index.html" class="custom-link" target="_blank"><b>Ketcher</b></a>. Dot notation is not permitted. Please include any co-factors the products(s) may be attached to.</div>
                </div>
            </div>
            <div class="col-auto mx-auto">
        ...
        <div class="row d-flex align-items-center mb-1">
            <div class="col">
                <div class="form-floating">
                    ...
                    <div id="ForbiddenProductsHelp" class="form-text">A single forbidden reaction product SMILES string. Dot notation is not permitted. Please include any co-factors the products(s) may be attached to.</div>
                </div>
            </div>
            <div class="col-auto mx-auto">

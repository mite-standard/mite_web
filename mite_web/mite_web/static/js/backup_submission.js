...
function addKnownReaction(outerindex) {
        ...
        <div class="knownreaction">
            <div class="card card-body">
                ...
                <div class="row mb-2">
                    <div class="col">
                        <div class="form-floating">
                            <input type="text" name="reaction[${outerindex}]knownreaction[${index}]substrate" id="reaction[${outerindex}]knownreaction[${index}]substrate" class="form-control" aria-describedby="KnownreactionSubstrateHelp"  value="" required>
                            <label for="reaction[${outerindex}]knownreaction[${index}]substrate" class="form-label">Substrate SMILES</label>
